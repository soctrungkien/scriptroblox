...
local title = Instance.new("TextLabel")
	...
	title.Text = "c00lgui Reborn Rc7 bởi v3rx"
...
local localp = Instance.new("Frame")
	...
	localp.Name = "Người chơi địa phương"
...
local psd = Instance.new("Frame")
	...
	psd.Name = "ID Skybox/Decal được đặt trước"
